                ...
                <div class="card-header">
                    <div class="form-group">
                      <a href="{{ route('users.create') }}" class="btn btn-outline-primary float-right" style="margin-left: 4%;">
                        ...
                        Batch updateschools from TAMISEMI systems</a>
                        <a href="{{ route('users.create') }}" class="btn btn-outline-success float-right">
                          <i class="fa fa-plus"></i>
                          Retrive schools from TAMISEMI systems</a>

                    </div>
                  <h3 class="card-title">List of all TAMISEMI schools</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
